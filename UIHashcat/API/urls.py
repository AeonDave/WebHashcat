...
urlpatterns = [
    ...
    re_path(r'^hashfile_top_password_len/(.*)/(.*)$', views.api_hashfile_top_password_len,
            name='api_hashfile_top_password_len'),
    re_path(r'^hashfile_top_password_charset/(.*)/(.*)$', views.api_hashfile_top_password_charset,
            name='api_hashfile_top_password_charset'),
